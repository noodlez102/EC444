...
void app_main(void)
{
    ...
    while (1) {
        ...
        int integerPart = (int)volts;          // Extract integer part
        char integerChar = (char)(integerPart+'0');
        int decimalPart = (int)((volts - integerPart) * 100); // Extract decimal part
        int tenthsPart = decimalPart/10;
        char tenthsChar = (char)(tenthsPart+'0');
        int hundredthsPart = decimalPart%10;
        char hundrethsChar = (char)(hundredthsPart+'0');

        printf("%d\n",tenthsPart);
        displaybuffer[0]= alphafonttable[(int)integerChar]+0b0100000000000000;
        displaybuffer[1]= alphafonttable[(int)tenthsChar];
        displaybuffer[2]= alphafonttable[(int)hundrethsChar];
