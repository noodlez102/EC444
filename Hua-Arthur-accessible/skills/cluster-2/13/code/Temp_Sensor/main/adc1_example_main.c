...
void app_main(void)
{
    ...
    while (1) {
        ...
        float value = (4095 / (float)adc_reading) - 1;
        float temp = (1 / ((1 / 298.15) + (1 / 3435) * log(value))) - 273.15;
        printf("Temp: %f", temp);
        char buff[20];
        ...
        if(temp>=10){
            displaybuffer[1] = displaybuffer[1] | alphafonttable['.'];
        }else{
            displaybuffer[0] = displaybuffer[0] | alphafonttable['.'];
        }
        
        displaybuffer[3] = alphafonttable['C'];
